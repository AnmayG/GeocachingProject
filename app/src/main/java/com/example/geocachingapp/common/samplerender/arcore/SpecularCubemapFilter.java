 ...
 */
package com.example.geocachingapp.common.samplerender.arcore;
...
public class SpecularCubemapFilter implements Closeable {
   ...
   *
   * <p>This method should be called every frame with the result of {
   * com.google.ar.core.LightEstimate.acquireEnvironmentalHdrCubeMap()} to update the filtered
   * cubemap texture, accessible via {getFilteredCubemapTexture()}.
   *
