 ...
 * <p>
 */
public class LocationInfoContent {

    /**
     * An array of sample (placeholder) items.
     */
    public static final List<LocationInfo> ITEMS = new ArrayList<>();

    /**
     * A map of sample (placeholder) items, by ID.
     */
    public static final Map<String, LocationInfo> ITEM_MAP = new HashMap<>();
    ...
    private static void addItem(LocationInfo item) {
        ITEMS.add(item);
